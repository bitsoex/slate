...
### Generate JAVA entries enums

To generate the java entries for the enum `WebAPIErrorCodes` you can run:
```
python ./scripts/java_enum_entries_generator.py
```
To print the entries in the console. After that you can copy-paste this in the enum class.
