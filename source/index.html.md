...
**price** | - | No | If supplied, this will place a **limit order** to
buy at the specified price. If not supplied, this will place a **market order** to buy the amount of major currency specified in **amount** at the market rate
